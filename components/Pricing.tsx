    ...
    <section id="formules" className="section-shell relative overflow-hidden bg-base-alt">
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-2">
          <div className="glass-card flex flex-col rounded-card border-t-2 border-coral/40 p-7 transition-transform duration-300 hover:-translate-y-1">
          ...
          <div className="glass-card-highlight relative flex scale-[1.02] flex-col rounded-card border-t-2 border-lagoon p-7 shadow-[0_20px_60px_-15px_rgba(0,194,178,0.35)] transition-transform duration-300 hover:-translate-y-1">
